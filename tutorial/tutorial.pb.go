...
func (x *Offering) GetGift() string {
	if x != nil {
		return x.Gift
	}
	return ""
...
func (x *Offering) GetValue() int32 {
	if x != nil {
		return x.Value
	}
	return 0
...
var file_tutorial_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x34, 0x0a, 0x08,
	0x4f, 0x66, 0x66, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x67, 0x69, 0x66, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x67, 0x69, 0x66, 0x74, 0x12, 0x14, 0x0a, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x22, 0x39, 0x0a, 0x05, 0x43, 0x68, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x61,
	...
	0x08, 0x54, 0x75, 0x74, 0x6f, 0x72, 0x69, 0x61, 0x6c, 0x12, 0x28, 0x0a, 0x08, 0x73, 0x61, 0x79,
	...
	0x79, 0x22, 0x00, 0x12, 0x24, 0x0a, 0x0d, 0x74, 0x72, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65, 0x43,
	0x68, 0x65, 0x73, 0x74, 0x12, 0x09, 0x2e, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x1a,
	0x06, 0x2e, 0x43, 0x68, 0x65, 0x73, 0x74, 0x22, 0x00, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x74,
...
var file_tutorial_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_tutorial_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: HelloRequest
	(*HelloReply)(nil),   // 1: HelloReply
	(*Offering)(nil),     // 2: Offering
	(*Chest)(nil),        // 3: Chest
}
var file_tutorial_proto_depIdxs = []int32{
	0, // 0: Tutorial.sayHello:input_type -> HelloRequest
	2, // 1: Tutorial.treasureChest:input_type -> Offering
	1, // 2: Tutorial.sayHello:output_type -> HelloReply
	3, // 3: Tutorial.treasureChest:output_type -> Chest
