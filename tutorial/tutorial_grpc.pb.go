...
type TutorialClient interface {
	...
	TreasureChest(ctx context.Context, in *Offering, opts ...grpc.CallOption) (*Chest, error)
}
...
func (c *tutorialClient) TreasureChest(ctx context.Context, in *Offering, opts ...grpc.CallOption) (*Chest, error) {
	out := new(Chest)
	err := c.cc.Invoke(ctx, "/Tutorial/treasureChest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TutorialServer interface {
	...
	TreasureChest(context.Context, *Offering) (*Chest, error)
...
func (UnimplementedTutorialServer) TreasureChest(context.Context, *Offering) (*Chest, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TreasureChest not implemented")
}
...
func _Tutorial_TreasureChest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Offering)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TutorialServer).TreasureChest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Tutorial/treasureChest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TutorialServer).TreasureChest(ctx, req.(*Offering))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Tutorial_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "treasureChest",
			Handler:    _Tutorial_TreasureChest_Handler,
		},
	},
